...
const mockTask = { id: 't1', projectId: 'p1', title: 'Add login feature', description: 'Implement JWT-based login endpoint', status: 'pending', priority: 100, retryCount: 0, maxRetries: 3, createdAt: Date.now(), updatedAt: Date.now() };
